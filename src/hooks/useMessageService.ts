...
const useMessageService = () => {
  ...
  const methodsFunc: () => {
    ...
    SET_VIDEO_INFO: async (params: { url: string, title: string, aid: number | null, ctime: number | null, author?: string, pages: any, chapters: any, infos: any }, context: MethodContext) => {
